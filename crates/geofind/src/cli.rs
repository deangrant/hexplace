...
#[derive(Debug, Parser)]
#[command(name = "geofind", version, about)]
pub struct Cli {
    #[command(subcommand)]
    pub command: Command,
}

/// Top-level Geofind subcommands.
...
pub struct ServeArgs {
    ...
    pub data_dir: PathBuf,
    /// Listen address.
    #[arg(long, env = "GEOFIND_BIND", default_value = "127.0.0.1:8080")]
    pub bind: SocketAddr,
}

/// Arguments for `geofind search`.
#[derive(Debug, Parser)]
